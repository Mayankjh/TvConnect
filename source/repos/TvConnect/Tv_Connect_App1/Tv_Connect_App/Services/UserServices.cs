...
namespace Tv_Connect_App.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public Admin AuthenticateAdmin(string email, string password)
        {
            ...
            var admin = _context.Admin.SingleOrDefault(x => x.Admin_Email== email );
        ...
        public Admin CreateAdmin(Admin admin, string password)
        {
            ...
            if (_context.Admin.Any(x => x.Admin_Email== admin.Admin_Email))
                throw new AppException("Email \"" + admin.Admin_Email + "\" is already taken");
